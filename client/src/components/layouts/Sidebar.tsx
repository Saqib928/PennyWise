...
import { Wallet, PieChart, Activity, Users, Settings, LogOut } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-64 bg-white border-r border-gray-100 flex-col shadow-sm z-20">
      ...
      <div className="p-4 border-t border-gray-50">
        ...
        {/* Logout Button */}
        <button className="w-full mt-4 flex items-center gap-3 px-4 py-3 text-gray-500 hover:text-red-500 transition-colors text-sm font-medium">
            <LogOut size={18} />
            <span>Sign Out</span>
        </button>
      </div>
